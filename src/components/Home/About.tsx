    ...
    <section id="about" className="text-gray-700">
      <SystemUI>
        ...
        <div className="col-span-12 xl:col-span-6 grid xl:gap-4 self-center">
          ...
          <button className="col-span-3 col-start-4 bg-primary text-3xl text-black  capitalize font-bold px-12 rounded-lg py-2 text-attention flex xl:gap-2 hover:shadow-xl hover:shadow-primary/30 hover:translate-y-1 transition shadow-2xl shadow-primary/50 ">
            Explore
