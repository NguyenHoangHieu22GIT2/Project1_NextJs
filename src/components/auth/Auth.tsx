          ...
          {isLogin ? (
            ...
            <>
              ...
              <ol className="list-decimal">
                ...
                <li>
                  <p>
                    The password should have at least 1 lowercase, 1 uppercase,
                    1 symbol and 1 number, also it should be at least 5
                    characters long
                  </p>
                </li>
                <li>
                  <p>
                    A username for a cool guy like you is neccessary as well :D
                  </p>
                </li>
              </ol>
            </>
