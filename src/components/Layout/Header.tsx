  ...
  if (data) {
    ...
    cartItemElements = cartItems.map(cartItem =>
      <li className="flex justify-between" key={cartItem._id}>
        <div>
          <Image src={cartItem.imageUrl} width={150} height={150} alt={cartItem.title} />
  ...
  return (
    <header className="text-gray-900 sticky top-0  w-full z-10 backdrop-blur-sm font-primary py-5 shadow-lg ">
      <SystemUI>
        ...
        <div className="col-start-12 flex gap-2 xl:hidden">
        ...
        <AnimatePresence mode="wait">
          {
            openCart &&
            <Card class="fixed top-full right-5 w-fit bg-white" animation={{
              initial: { opacity: 0 },
              animate: { opacity: 1 },
              exit: { opacity: 0 },
            }}>
              ...
              >
                ...
                >
                  <li className="hover:text-primary transition ">
                    <Link
                      className={`inline-block   ${route.pathname == "/" && "text-primary font-bold"
                        }`}
                      href="/"
                    >
                      Home
                  ...
                  <li className="hover:text-primary transition ">
                    <Link
                      className={`inline-block   ${route.pathname == "/products/1" &&
                    ...
                    <>
                      <li className="hover:text-primary transition ">
                        <Link
                          ...
                          className={`inline-block   ${route.pathname == "/create-product" &&
                            "text-primary font-bold"
                            }`}
                        >
                          Create Products
                  ...
                  <li className="hover:text-primary transition ">
                    {isAuth ? (
                      ...
                      <Link
                        href="/auth"
                        className={`inline-block   ${route.pathname == "/auth" && "text-primary font-bold"
                          }`}
                      >
                        Auth
                      </Link>
        ...
        <nav className="col-span-7 col-start-7 hidden xl:flex justify-center items-center w-full ">
          ...
          >
            ...
            <li className="hover:text-primary transition ">
              <Link
                href="/products/1"
                className={`inline-block   ${route.pathname == "/products" && "text-primary font-bold"
                  }`}
              >
                Products
              </Link>
