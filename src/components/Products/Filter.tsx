...
export function Filter(props: PropsWithChildren) {
  ...
  return (
    <section>
      <SystemUI>
        <h1 className="text-attention relative col-span-3 xl:col-span-2 text-center  text-white before:content-[''] before:w-full before:h-1 before:bg-slate-200 before:absolute before:bottom-0 before:left-0">
          Filters
        </h1>
        ...
        <form className="col-span-12 text-white" action="">
